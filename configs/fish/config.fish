...
alias upgrade="takeSnapshot;mirru;bash -c 'for i in {1..5}; do sudo pacman -Syyyu --noconfirm;yay -Syyyu --noconfirm && break || sleep 1; done';rgi"
...
alias rgi="sudo grub-mkconfig -o /boot/grub/grub.cfg;sudo mkinitcpio -P"
